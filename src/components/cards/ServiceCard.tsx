...
const ServiceCard = () => {
  ...
  return (
    <div className="pt-10 px-4 md:pt-16 md:px-8 lg:px-32">
      <div className="bg-white p-4 border-2 rounded relative flex flex-col overflow-hidden sm:flex-row-reverse lg:max-h-[270px]">
        <div className="z-10 pb-6 sm:pb-0 sm:w-5/12 lg:w-5/12 xl:w-4/12">
          <Image
        ...
        <div className="sm:w-7/12 sm:min-h-full sm:flex sm:flex-col sm:justify-between lg:w-7/12 xl:w-8/12">
          <p className="z-10 text-pretty sm:pr-4 sm:text-sm md:text-base lg:text-lg">
          ...
          <button
            ...
            ref={servicesRef}
            className="w-full z-10 pt-6 flex items-center gap-1"
          >
            <p className="text-2xl z-10 uppercase md:text-3xl">Services</p>
            <ArrowForward
        ...
        <span /* Abajo Derecha pequeña */
          className={`absolute bottom-[-3rem] right-[-3rem] rounded-full bg-[#b0a17b99] z-0 min-w-24 min-h-24`}
        ></span>
        <span /* Abajo Derecha grande */
          className={`absolute bottom-[-4.5rem] right-[-4.5rem] rounded-full bg-[#b0a17b99] z-0 min-w-40 min-h-40`}
        ></span>
        <span /* Abajo Izq mediana */
          className={`absolute bottom-[-4.5rem] left-[-4.5rem] rounded-full bg-[#b0a17b99] z-0 min-w-32 min-h-32`}
        ></span>
        <span /* Abajo Izq pequeña */
          className={`absolute bottom-[-6rem] left-[-6rem] rounded-full bg-[#b0a17b99] z-0 min-w-32 min-h-32`}
        ></span>
        <span /* Arriba Izq mediana */
          className={`absolute top-16 left-[-2rem] rounded-full bg-[#b0a17b99] z-0 min-w-16 min-h-16`}
        ></span>
        <span /* Arriba Derecha mediana */
          className={`absolute top-[-2rem] right-2 rounded-full bg-[#b0a17b99] z-0 min-w-16 min-h-16`}
        ></span>
      </div>
    </div>
  );
